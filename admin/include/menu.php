<nav class="sidebar sidebar-offcanvas" id="sidebar">
        <ul class="nav">
          ...
          <li class="nav-item">
           ...
           <li class="nav-item">
            <a class="nav-link" data-toggle="collapse" href="#ui-story" aria-expanded="false" aria-controls="ui-story">
            ...
            <div class="collapse" id="ui-story">
              <ul class="nav flex-column sub-menu">
                ...
                <li class="nav-item"> <a class="nav-link" href="viewstory.php">View story</a></li>
              </ul>
            </div>
          </li>
           <li class="nav-item">
